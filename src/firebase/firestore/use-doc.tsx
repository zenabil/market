...
export function useDoc<T = any>(
  ...
  if(memoizedDocRef && !memoizedDocRef.__memo) {
    throw new Error('DocumentReference passed to useDoc was not properly memoized using useMemoFirebase. This will cause performance issues and potentially infinite loops.');
  }
